...
class Mail
{
	...
	*/
	...
	function __construct($charset="")  // --- my fix
	{
		$this->autoCheck( true );
	...
	*/
	function BuildMail()
	{
		...
		$this->xheaders["X-Mailer"] = "vopas.com.ua";
...
//			}
	...
	*/
	function Send()
	{
		...
		if(!$this->smtp_on)
		{
			$res = @mail( $this->strTo, $this->xheaders['Subject'], $this->fullBody, $this->headers, '-fno-reply@vopas.com.ua' );
		}
